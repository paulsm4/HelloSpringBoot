...
class TodoRestController {
    ...
    public Flux<Todo> getBySummary(@RequestParam(name="summary", required=true) String summary) {
        return todoService.getBySummary(summary);
    }

    @GetMapping("/getByCategory")
    public Flux<Todo> getByCategory(@RequestParam(name="categoryName", required=true) String categoryName) {
        return todoService.getByCategory(categoryName);
    }
